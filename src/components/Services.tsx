    ...
    <section ref={targetRef} className="p-6 lg:p-8 relative h-[300vh]">
      <div className="sticky top-0 flex flex-col h-screen items-start justify-center overflow-hidden">
        ...
        <motion.div style={{ x }} className="bg-primary-100 flex flex-row gap-8  pr-8">
          ...
          <Link
            href="/calculator" className="absolute mt-8 -z-10 h-[460px] font-sans w-[88vw] lg:w-[100vw] uppercase antialiased inline-flex items-center justify-center px-5 py-3 text-7xl text-center bg-white text-primary-100 hover:bg-white focus:ring-4 focus:ring-gray-100">
            Get a Quote

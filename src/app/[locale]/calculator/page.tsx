...
export default function Calculator() {
  ...
  return (
    <FormProvider {...methods}>
      <section className="px-4 lg:px-8 h-screen flex items-center">
        <form className="flex flex-col w-full" onSubmit={handleSubmit(onSubmit)}>
          <h1 className="font-mono text-xs uppercase mb-4">{steps[step]}</h1>
          <div className="grid grid-cols-12 gap-6 w-full flex flex-col">
            ...
            <div className="absolute bottom-0 w-[96vw] pb-8 flex justify-between gap-4 mt-4">
              <p className="text-xl">Total estimated: <strong>{isNaN(totalCost) ? "0" : totalCost.toFixed(2)}</strong></p>
